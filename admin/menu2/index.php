...
function openEditModal(item) {
    ...
    document.getElementById('menuEditImagePreview').src = item.image;
...
function saveEditedItem(e) {
    ...
    const name = document.getElementById('menuEditName').value;
    const price = document.getElementById('menuEditPrice').value;
    const image = document.getElementById('menuEditImage').value;
    
    // Update the item
    const itemIndex = allMenuItems.findIndex(item => item.id === currentEditingItem.id);
    if (itemIndex !== -1) {
        allMenuItems[itemIndex] = {
            ...allMenuItems[itemIndex],
            name,
            price,
            image: image || allMenuItems[itemIndex].image
        };
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector('.menu-edit-close-modal').addEventListener('click', closeEditModal);
    document.getElementById('menuEditForm').addEventListener('submit', saveEditedItem);
